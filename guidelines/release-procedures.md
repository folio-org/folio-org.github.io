...
* As explained in the CI process, the files (install.json, okapi-install.json, stripes-install.json) are autogenerated by Jenkins, so do not manually edit those.
