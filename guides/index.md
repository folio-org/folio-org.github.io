...
- For Contextual Query Language (CQL) examples, see the [Glossary](/reference/glossary/#cql), the FOLIO [CQL to PostgreSQL JSON converter](https://github.com/folio-org/raml-module-builder/tree/master/cql2pgjson), the [API docs](/reference/api/), and the debug output for tests in each backend module.
