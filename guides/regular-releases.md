...
The approximate dates and descriptive flower-based names (e.g. Goldenrod, Honeysuckle, Iris) for upcoming releases are also listed there, along with calendars and milestone deadlines to assist planning.
