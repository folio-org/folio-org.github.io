...
The [FOLIO Spring-Way](/spring-way/#spring-way) defines the module’s development approach for FOLIO platform using the Spring framework and Spring projects.
