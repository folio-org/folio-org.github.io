...
layout: tutorials
title: Introduction
heading: Folio Developer's Curriculum
permalink: /tutorials/foliocurriculumintro/
---
...
## Lessons/Steps
1. [Clone, build and explore Okapi](/tutorials/clonebuildexploreokapi)
1. [Initialize Okapi Gateway from the command line](/tutorials/initializeokapifromthecommandline)
1. [Enable Okapi Authentication](/tutorials/enableokapiauthentication)
1. [Deploy test Stripes package](/tutorials/deployteststripesmodule)
1. Real-world application: [set up the FOLIO Users app](/tutorials/setuptheokapiusersapp)
